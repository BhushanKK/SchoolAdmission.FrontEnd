$(document).ready(function () {
        ...
        columns: [
            ...
            { data: "divisionName" },
            {
                ...
                render: function (data, type, row) {
                    return `
                        <button class="btn btn-sm btn-warning editBtn" data-id="${row.divisionId}">Edit</button>
                        <button class="btn btn-sm btn-danger deleteBtn" data-id="${row.divisionId}">Delete</button>
                    `;
                }
            }
        ]
    ...
    $('#savedivisionBtn').click(function () {
        ...
        const url = id ? `${apiBase}/divisionmasters/${id}` : `${apiBase}/divisionmasters`;
    ...
    $('#confirmDeleteBtn').click(function () {
        ...
        $.ajax({
            url: `${apiBase}/divisionmasters/${deleteId}`,
            method: "DELETE",
            headers: {
                "Authorization": "Bearer " + localStorage.getItem("accessToken")
            },
